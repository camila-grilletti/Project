...
$(document).ready(function() {
    $('body').on('click', '#abrirModal', function(e) {
        e.preventDefault();
        if (window.innerWidth < 1024) {
            $(this).next("#overlay-cant").css("display", "flex");
            $(this).next("#overlay-cant").children("#cantidad").children(".container").children("#modal").css("display", "flex");
            disableScroll();
        }
    })
})
...
$(document).ready(function() {
    $('body').on('click', '#cerrarModal', function(e) {
        e.preventDefault();
        if (window.innerWidth < 1024) {
            $(this).closest(".otros-datos__cantidad").children("#overlay-cant").css("display", "none");
            $(this).closest(".otros-datos__cantidad").children("#overlay-cant").children("#cantidad").children(".container").children("#modal").css("display", "none");
            enableScroll();
        }
    })
})
